...
describe('Restaurant Settings', () => {
  ...
  describe('Working Hours', () => {
    ...
    test('Should update working hours of a restaurant', done => {
      request(API).put('/api/restaurant/61d4b04efafc4eb99190c7c4/settings/working-hours')
  ...
  describe('Tables', () => {
    ...
    test('Should add a table', done => {
      request(API).post('/api/restaurant/61d4b04efafc4eb99190c7c4/settings/tables')
        .set('Accept', 'application/json')
        .send(data)
        .end((err, res) => {
          expect(res.status).toBe(201);
    ...
    test('Should update a table', done => {
      ...
      validData.floor = 9;
      request(API).put('/api/restaurant/61d4b04efafc4eb99190c7c4/settings/tables')
        .set('Accept', 'application/json')
        .send(validData)
        .end((err, res) => {
          expect(res.status).toBe(201);
